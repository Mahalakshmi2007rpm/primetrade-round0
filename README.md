...
Generate clustering bonus outputs:

```bash
python src/bonus_clustering.py
```
...
- Predictive model: next-day profitability bucket in notebook section 11.
- Clustering: trader archetypes generated by src/bonus_clustering.py.
- Dashboard: interactive explorer in streamlit_app.py.
